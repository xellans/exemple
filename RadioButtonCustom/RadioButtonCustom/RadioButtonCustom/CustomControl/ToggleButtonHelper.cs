...
namespace RadioButtonCustom.CustomControl
{
    ...
    {
        public static ToggleButton GetButtonSource(UIElement uie)
        {
            return (ToggleButton)uie.GetValue(ButtonSourceProperty);
        }

        public static void SetButtonSource(UIElement obj, ToggleButton bttn)
        {
            obj.SetValue(ButtonSourceProperty, bttn);
        }
